...
\setbeamertemplate{background}{
  ...
  \begin{tikzpicture}
    ...
    \else % inner page
      % header
      \fill[color=PondeRed] (0, \slideheight-10mm) rectangle(\slidewidth,\slideheight);
      \node[anchor=north east]at(\slidewidth,\slideheight){\color{PondeBlack}\scriptsize\insertsection};
      \node[anchor=north west,inner ysep=0.5mm]at(5mm,\slideheight-1.5mm){\color{PondeWhite}\LARGE\textbf{\insertframetitle}};

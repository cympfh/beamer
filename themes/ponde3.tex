...
\setbeamertemplate{background}{
  \begin{tikzpicture}
    ...
    % \else
    %   \node[opacity=0.8, anchor=south east] at (0.95\paperwidth, -0.03\paperheight) {
    %     \includegraphics[width=0.15\paperwidth,bb=0 0 348 476]{../../bin/img/azusa.png}};
    \fi
  \end{tikzpicture}
}
...
\setbeamertemplate{navigation symbols}{
  ...
  \ifnum\thepage>1\relax
    \begin{tikzpicture}
      ...
      \fill[fill=PondeRed!20] (0,0) circle (2.2mm);
      \fill[fill=PondeRed]
      (0,0) -- (90:2.2mm) arc (90:90-\the\p/\the\q*360:2.2mm) -- cycle;
      \fill[fill=white] (0,0) circle [x radius=1.8mm,y radius=1.8mm];
      \node[color=PondeRed,font=\tiny] at (0,0) {\the\p};
    \end{tikzpicture}
  \fi
}
